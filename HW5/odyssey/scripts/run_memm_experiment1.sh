...
#SBATCH -e /n/home09/ankitgupta/CS287/CS287assignments/HW5/odyssey/outputs/err/memm_exp1/setup_%A_%a_err.txt            #File to which standard err will be written
...
readarray -t config < /n/home09/ankitgupta/CS287/CS287assignments/HW5/odyssey/scripts/memm_experiment1_config.txt
