...
#SBATCH -o /n/home09/ankitgupta/CS287/CS287assignments/HW3/odyssey/outputs/out/nce/setup_%A_%a_out.txt            #File to which standard out will be written
#SBATCH -e /n/home09/ankitgupta/CS287/CS287assignments/HW3/odyssey/outputs/err/nce/setup_%A_%a_err.txt            #File to which standard err will be written
