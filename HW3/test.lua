...
function forwardandBackwardPass2(model, modelparams, modelgradparams, lookuptable, lookuptableparameters, lookuptablegradparameters, input_minibatch, output_minibatch, sample_indices, probs, eta)
	...
	-- Determine which rows to pick from lookuptable
	local rows_wanted = torch.zeros(K+1):long()
	rows_wanted:narrow(1, 2, K):add(sample_indices)
