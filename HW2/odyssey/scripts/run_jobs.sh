...
readarray -t config < ~/CS287/HW1/scripts/config_lr.txt
...
th /n/home09/ankitgupta/CS287/CS287assignments/HW2 \
  -datafile /n/home09/ankitgupta/CS287/CS287assignments/HW2/PTB.hdf5
  -classifier lr
