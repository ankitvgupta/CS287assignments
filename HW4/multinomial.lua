...
function laplace_viterbi_segment_try2(flat_valid_input, trie, alpha, window_size, space_idx)
...
function laplace_viterbi_segment_try3(flat_valid_input, trie, alpha, window_size, space_idx)
