...
#SBATCH -o /n/home09/ankitgupta/CS287/CS287assignments/HW4/odyssey/outputs/out/rnn_exp4/setup_%A_%a_out.txt            #File to which standard out will be written
#SBATCH -e /n/home09/ankitgupta/CS287/CS287assignments/HW4/odyssey/outputs/err/rnn_exp4/setup_%A_%a_err.txt            #File to which standard err will be written
...
readarray -t config < /n/home09/ankitgupta/CS287/CS287assignments/HW4/odyssey/scripts/rnn_experiment4_config.txt
...
rnn1=${selected_config[11]}
rnn2=${selected_config[12]}
dropout=${selected_config[13]}
